...
uses
  System.SysUtils, System.Math, Base32Utility_u, System.DateUtils, IdGlobal,
  IdHMACSHA1;
...
begin
  Result := '';
  ValCharLen := length(Base32Utility_u.cValidChars);
  ...
  for i := 1 to len do
  begin
    Result := Result + copy(Base32Utility_u.cValidChars,
