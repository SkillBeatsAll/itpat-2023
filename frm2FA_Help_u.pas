...
begin
  ...
  try
    ...
    { this code creates the QR code by writing to the bitmap }
  ...
  // handles image + bitmap combo
  // this actually displays the QR code in the image.
  ...
  // code necessary to avoid overly blurry QR code
...
var
  sUrl: String;
begin
  { dynamically update URL for the online option }
